...
export const StakingSummary = () => {
	...
	return (
		<>
			<div className="w-min lg:w-1/4 mb-4 lg:mb-0 p-4 lg:p-6 mx-2 lg:mx-4 bg-white flex flex-col rounded-3xl shadow-lg">
				<dl>
			...
			<div className="w-min lg:w-1/4 mb-4 lg:mb-0 p-4 mx-2 lg:mx-4 bg-white flex flex-col rounded-3xl shadow-lg">
